      ...
      <div class="container">
        ...
        >
          <div class="testimonial-item text-center">
            ...
            <div class="testimonial-text rounded text-center p-4">
              <p>
                Semoga Donasi yang kita berikan mampu untuk membantu para korban bencana.</p>
              <h5 class="mb-1">Joko</h5>
          ...
          <div class="testimonial-item text-center">
            ...
            <div class="testimonial-text rounded text-center p-4">
              <p>
              Tetap semangat, setiap cobaan pasti ada jalan keluarnya.</p>
          ...
          <div class="testimonial-item text-center">
            ...
            <div class="testimonial-text rounded text-center p-4">
              <p>
                Setiap manusia berhak mendapatkan pakaian yang layak. </p>
              <h5 class="mb-1">Fatih</h5>
              <span class="fst-italic">Papua</span>
            </div>
          </div>
        </div>
      </div>
