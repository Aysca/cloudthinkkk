                      ...
                      <table class="table table-bordered">
                        ...
                        while($row = mysqli_fetch_array($kategori)){
                          ...
                          <tr>
                            ...
                            <td><?php echo ($row['status'] == 1) ? 'Belum Terpenuhi' : (($row['status'] == 2) ? 'Terpenuhi Sebagian' : (($row['status'] == 3) ? 'Terpenuhi' : (($row['status'] == 4) ? 'Permintaan Ditolak' : ''))); ?></td>                          
                            <td><a class="btn btn-success" href="edit-pengajuan.php?id=<?php echo $row['pengajuan_id'] ?>">Edit</a> || <a href="delete-pengajuan.php?id=<?php echo $row['pengajuan_id'] ?>" onclick="return confirm('Yakin ingin menghapus data?')"  class="btn btn-danger" >Delete</a></td>
                          </tr>
                          <?php } ?>
